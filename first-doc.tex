...
\usepackage{setspace} %Este apcote altera espaçamento entre linhas
...
\begin{document}
	...
	\begin{tiny}
		texto pequeno \\ %quebra linha
	\end{tiny}
	
	Texto normal \\ %quebra linha
	...
	\section{Seção espaçamento linhas}
		...
		\space{1.5cm} %Espaçamento personalizado entre linhas
